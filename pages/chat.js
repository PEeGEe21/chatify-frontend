...
//   };
  ...
  return (
    <>
        ...
        <div className={`container-bx border-r border-[#151515] ${styles.container}`}>
            <div className="w-full  absolute py-4 bg-[#151515] border-t border-[#5e5e5e80] shadow px-2 z-10 hidden md:block ">
              ...
              <div className="flex md:items-center md:justify-between">
                  ...
                  <div className="flex-1 flex items-center justify-end">
                      ...
                      <div className="flex items-center mt-4 md:mt-0">
                          ...
                          <div className="relative inline-block ">
                              <button className="relative z-10 block p-2 text-gray-700 bg-[#1d1d1d] border border-transparent rounded-md dark:text-white focus:border-[#5e5e5e80] focus:ring-opacity-40 dark:focus:ring-opacity-40 focus:ring-blue-300 dark:focus:ring-blue-400  dark:bg-gray-800 focus:outline-none" onClick={handleShowFriendMenu} ref={ref}>
